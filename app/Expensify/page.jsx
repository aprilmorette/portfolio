  ...
  return (
    <div id="project">
      ...
      <div className="flex">
        ...
        <main className="max-w-6xl mx-10">
          <section id="overview">
                ...
                <div className="mt-4 mx-4">
                  ...
                  <ul className="list-disc mx-5">
                    ...
                    <li>
                      ...
                      for category-wise distribution and line charts for expense
                      trends over time).
                    </li>
                    <li>
            ...
            <div className="my-10 card p-4">
              ...
              <div className="m-4">
                ...
                <p>
                  ...
                  their history, the user specifies the category, amount, and
                  date in the designated fields. If any of these fields are left
                  blank, the system notifies the user to complete all required
                  inputs. Once all fields are filled and the user clicks the
                  "Add" button, the expense is stored in the database. The
                  system immediately updates the user interface to display the
                  newly added expense at the top of the expense history, along
                  with an updated total amount for all logged expenses. The user
                  then deletes the newly created expense by clicking the
                  "Delete" button next to the corresponding log entry.
                </p>
              </div>
              ...
              <div className="m-4">
                ...
                <p>
                  ...
                  selects the categories "Education" and "Rent" and chooses the
                  timeframe "Last 7 Days." By clicking "Apply Filters," the
                  system updates the view to show all expenses that fall under
                  either education or rent logged in the past week. To return to
                  the complete expense history, the user clicks the "Filter"
                  button again and selects "Reset Filters," restoring the
                  unfiltered view of all logged expenses.
                </p>
              </div>
              ...
              <div className="m-4">
                ...
                <p>
                  ...
                  chart is generated, visually representing all expenses logged
                  during the month, categorized on the x-axis and with the
                  y-axis indicating the corresponding amounts. Once the user is
                  finished reviewing the data, they click the "Sign Out" button.
                  The system logs the user out and redirects them to the
                  homepage, ensuring their session is securely ended.
                </p>
              </div>
            </div>
          </details>
            ...
            <div className="my-10">
              ...
              <ul className="list-disc">
                <li>
                  ...
                  additional accounts, such as Apple ID or social media
              ...
              <p>
                Input Validation: Expense amount field allows any characters to
                be submitted.
              </p>
              <ul className="list-disc">
                <li>
                  Maintenance: Limit input to only numbers and a single decimal
                  if needed.
                </li>
              </ul>
              <p>
                    ...
                    <li>
                      ...
                      <ul className="list-[circle] ps-5">
                        ...
                        <li>
                          ...
                          basic expense tracking (add, modify, delete expenses).
                        </li>
                        <li>
                    ...
                    <li>
                      ...
                      <ul className="list-[circle]">
                        <li className="pl-5">
                          ...
                          essential expense management features. Initial testing
                          validated the core functionalities, ensuring a strong
          ...
          <details id="conclusion" className="group">
            ...
            <div className="my-10">
              <p>
                ...
                creating an intuitive, secure, and efficient platform for users
                to manage their expenses. The application provides essential
              ...
              <ul className="list-disc">
                <li>
                  ...
                  aligning deliverables with timelines ensured efficient
